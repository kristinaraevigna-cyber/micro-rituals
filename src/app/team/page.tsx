          ...
          >
            ...
            <div>
              <TeamCard
                photo="/kristina.jpg"
                name="Kristina Shea"
                credentials="Researcher · Centre for Positive Health Sciences"
